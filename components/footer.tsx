...
function footer() {
    return (
        ...
        <footer className='p-4 bg-linear-to-r from-[#D9EEFF] to-[#F1F0F0]-500 '>
            <h1 className='font-bold text-[16px] md:text-[18px] md:ml-4 lg:ml-4 lg:text-[20px]'>ติดต่อเรา</h1>
            <div className='pt-4 flex  gap-6  md:gap-20 md:p-5 lg:gap-60'>
                <div className="life-box flex flex-col gap-3">
                    <div className='flex gap-4'>
                        ...
                        <p className='text-[10px] md:text-[14px] lg:text-[16px]'>062-916-9989</p>
                    </div >
                    <div className='flex gap-4'>
