...
function footer() {
    return (
        ...
        <footer className='p-6 bg-linear-to-r from-[#D9EEFF] to-[#F1F0F0]-500 '>
            <h1 className='font-bold text-base md:text-[18px] md:ml-4 lg:ml-4 lg:text-[20px]'>ติดต่อเรา</h1>
