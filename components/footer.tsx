            ...
            <div className='pt-4 flex flex-col  gap-3  md:gap-20 md:p-5 lg:gap-60 md:flex-row'>
                ...
                <div className="right-box flex flex-col gap-3 ">
                    <div className='flex gap-4'>
                        ...
                        <p className='text-[10px] md:text-[14px]  lg:text-[16px]'>555/268 หมู่ที่ 1 ตำบลบ้านทุ่ม อำเภอเมืองขอนแก่น จ.ขอนแก่น 40000</p>
                    </div>
                    <div className='flex gap-4'>
                        ...
                        <p className='  text-[10px] md:text-[14px]  lg:text-[16px] '>อาคารอำนวยการอุทยานวิทยาศาสตร์ภูมิภาค ภาคตะวันออกเฉียงเหนือ 1 (จังหวัดขอนแก่น) เลขที่ 123 หมู่ที่ 16 ถนนกัลปพฤกษ์ ตำบลในเมือง อำเภอเมือง จังหวัดขอนแก่น 40002</p>
                    </div>
                </div>
            </div>
        </footer>
