        ...
        <div className='pt-20 md:pt-30 lg:pt-19'>
            ...
            <div className='px-1.5 md:px-5 lg:px-10'>
                ...
                <div className='flex justify-center mb-5 gap-5'>
                    ...
                    onClick={() => setCurrentInPage(p => Math.max(p - 1, 1))}
                     className={`cursor-pointer p-1 rounded-md text-white 
                            ${currentPage === 1 ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#249cff]'}
                        `}
                    >
                    ...
                    <button
                        ...
                        className={`cursor-pointer p-1 rounded-md text-white 
                            ${currentPage === totalPage ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#249cff]'}
                        `}
